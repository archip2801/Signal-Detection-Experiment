...
expName = 'orientation discrimination'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\mihir\\Desktop\\Lab\\orientation discrimination_lastrun.py',
